...
RouteModel::Node *RoutePlanner::NextNode() {
    ...
    this->open_list.pop_back();
  	std::cout<<"NextNode, current size of: " << this->open_list.size() << " Distance from end " << next->h_value <<"\n";
    return next;
}
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    // Create path_found vector
  	//std::cout<<"constructfinalpath do i got here? \n";
    distance = 0.0f;
    ...
    while (current_node->parent){
        ...
        //std::cout<<"constructfinalpath do i stuck here? the while loop ? \n";
    }
...
void RoutePlanner::AStarSearch() {
    ...
    while (this->open_list.size() > 0){        
        current_node = this->NextNode();
      	//std::cout<<"current: " << current_node->x << ", " << current_node->y << "End: "<<this->end_node->x << ", " << this->end_node->y << "\n";
